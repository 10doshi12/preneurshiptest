    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_previous_education', models.CharField(max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_previous_education', models.CharField(max_length=50)),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='college', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
